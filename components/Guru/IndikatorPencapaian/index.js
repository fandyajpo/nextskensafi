...
const exampleData = [
  {
    kompetensi_dasar: "3.1  Memahami logika dan algoritma komputer",
    alokasi_waktu: 9,
    indikator: [
      {
        name: "•	Menjelaskan konsep logika dan algoritma",
      },
      {
        name: "• Menjelaskan lambing Flowchart",
      },
    ],
    unit_kompetensi: "Hanya sebatas pengetahuan dasar, tidak perlu diujikan",
    skema_sertifikasi: "Programmer Komputer",
    kompleksitas: 75,
    daya_dukung: null,
    intake: null,
  },
