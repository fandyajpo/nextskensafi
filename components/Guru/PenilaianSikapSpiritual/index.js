...
const exampleData = [
  {
    nilai: "A",
    nama_nilai: "Mengenal Materi keagamaan",
  },
  {
    nilai: "B",
    nama_nilai: "Sikap terhadap sesama siswa",
  },
  {
    nilai: "C",
    nama_nilai: "Sering Membantu sesama",
  },
  {
    nilai: "D",
    nama_nilai: "Disiplin datang tepat waktu",
  },
  {
    nilai: "E",
    nama_nilai: "Tidak melanggar aturan sekolah (tatib Sekolah)",
  },
];
        ...
        <div className="w-full h-full flex flex-col gap-3">
          <div className="w-full h-auto relative">
            <div className="w-full flex justify-between">
              <p className="text-xs font-bold">Instrumen</p>
              {errors.nama && (
          ...
          <div className="w-full h-auto relative">
            <div className="w-full flex justify-between">
              <p className="text-xs font-bold">Penilaian Sikap</p>
              {errors.nama && (
                <span className="text-xs text-red-500">Field required.</span>
              )}
            </div>
