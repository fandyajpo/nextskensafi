...
import { pembayaranKelas } from "components/Admin/Pembayaran/tableList";
...
const TablePengumuman = React.memo(({ act, pengumuman }) => {
  ...
  const datas = [
    {
      nama: "Alya Suherman",
      nomor_orangtua: "08772234214",
      status: "Lunas",
      jumlah_pembayaran: "1.000.000",
    },
    {
      nama: "Dira Andini",
      nomor_orangtua: "08772456762",
      status: "Belum Lunas",
      jumlah_pembayaran: "700.000",
    },
    {
      nama: "Faouzia Loui",
      nomor_orangtua: "08142325432",
      status: "Lunas",
      jumlah_pembayaran: "1.000.000",
    },
    {
      nama: "Obunaga",
      nomor_orangtua: "08452131223",
      status: "Belum Lunas",
      jumlah_pembayaran: "83.500",
    },
  ];
    ...
    <>
      <div className="h-14 bg-gray-50 flex justify-between px-4 py-3">
        <div className="text-sm font-semibold flex flex-col">
          <p className="h-full flex items-end">Pembayaran</p>
          <p className="h-full font-light text-xs">Daftar Pembayaran Murid</p>
        </div>
        <div className="text-3xl font-bold text-black flex items-center"></div>
      </div>
      <div className="w-full h-auto">
        <DataTable
          columns={pembayaranKelas(act)}
